...
contract ControllerHelperTest is TestDeployer, Test {
    ...
    function testDepositETH() public {
        ...
        controller.openPosition(
            ...
            DataType.OpenPositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 500, block.timestamp)
        );
    ...
    function testCannotOpenPositionBecauseSlippage() public {
        ...
        controller.openPosition(
            ...
            DataType.OpenPositionOption(lowerSqrtPrice, upperSqrtPrice, 500, block.timestamp)
        );
    }
    ...
    function testRepayHalfOfLPT() public {
        ...
        controller.closePosition(
            ...
            DataType.ClosePositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 54, 1e4, 500, block.timestamp)
        );
    ...
    function testCloseOneSubVault() public {
        ...
        controller.closeSubVault(
            ...
            DataType.ClosePositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 100, 1e4, 500, block.timestamp)
        );
    ...
    function testCannotClosePositionBecauseCallerIsNotOwner() public {
        ...
        controller.closeVault(
            ...
            DataType.ClosePositionOption(1500 * 1e6, 2000, 100, 1e4, 500, block.timestamp)
        );
    }
    ...
    function testCannotLiquidate() public {
        ...
        DataType.LiquidationOption memory option = DataType.LiquidationOption(100, 1e4, 500);
    ...
    function testLiquidatePartially() public {
        ...
        uint256 beforeBalance0 = token0.balanceOf(owner);
        controller.liquidate(vaultId, DataType.LiquidationOption(100, 5000, 500));
        uint256 afterBalance0 = token0.balanceOf(owner);
