...
contract ControllerHelperTest is TestDeployer, Test {
    ...
    function testCannotClosePositionBecauseCallerIsNotOwner() public {
        ...
        controller.closeVault(
            ...
            DataType.ClosePositionOption(1500 * 1e6, 2000, false, 0, emptyMetaData)
        );
    }
    ...
    function testDepositETH() public {
        ...
        controller.openPosition(
            ...
            DataType.OpenPositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 0, 1e18, 0, emptyMetaData)
        );
    ...
    function testDepositLPT() public {
        ...
        controller.openPosition(
            0,
            position,
            DataType.TradeOption(false, true, false, getIsMarginZero(), -1, -1),
            DataType.OpenPositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 1e10, 0, 0, emptyMetaData)
        );
    }
    ...
    function testBorrowLPT(uint256 _swapAmount) public {
        ...
        uint256 vaultId = controller.openPosition(
            ...
            // deposit margin
            DataType.OpenPositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 1000 * 1e6, 0, 0, emptyMetaData)
        );
    ...
    function testCannotOpenPositionBecauseSlippage() public {
        ...
        controller.openPosition(
            ...
            DataType.OpenPositionOption(lowerSqrtPrice, upperSqrtPrice, 1e10, 0, 0, emptyMetaData)
        );
    }
    ...
    function testWithdrawLPTWithSwapAnyway() public {
        ...
        controller.closeVault(
            ...
            DataType.ClosePositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), false, 0, emptyMetaData)
        );
    }
    ...
    function testCannotQuoterMode() public {
        ...
        controller.openPosition(
            ...
            DataType.OpenPositionOption(lowerSqrtPrice, upperSqrtPrice, 0, 0, 0, emptyMetaData)
        );
    }
    ...
    function testLiquidateBorrowLPTPosition() public {
        ...
        controller.liquidate(
            vaultId,
            DataType.LiquidationOption(getLowerSqrtPrice(), getUpperSqrtPrice(), false, 0, true)
        );
        uint256 afterBalance0 = token0.balanceOf(owner);
