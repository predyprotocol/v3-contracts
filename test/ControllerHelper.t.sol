...
contract ControllerHelperTest is TestDeployer, Test {
    ...
    function testDepositETH() public {
        ...
        controller.openPosition(
            ...
            DataType.OpenPositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 0, 1e18, emptyMetaData)
        );
    ...
    function testBorrowLPT(uint256 _swapAmount) public {
        ...
        uint256 vaultId = controller.openPosition(
            ...
            // deposit margin
            DataType.OpenPositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 1000 * 1e6, 0, emptyMetaData)
        );
    ...
    function testCannotOpenPositionBecauseSlippage() public {
        ...
        controller.openPosition(
            ...
            DataType.OpenPositionOption(lowerSqrtPrice, upperSqrtPrice, 1e10, 0, emptyMetaData)
        );
    }
    ...
    function testWithdrawLPTWithSwapAnyway() public {
        ...
        controller.closeVault(
            ...
            DataType.ClosePositionOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 100, emptyMetaData)
        );
    }
    ...
    function testCannotQuoterMode() public {
        ...
        controller.openPosition(
            ...
            DataType.OpenPositionOption(lowerSqrtPrice, upperSqrtPrice, 0, 0, emptyMetaData)
        );
    }
    ...
    function testLiquidateBorrowLPTPosition() public {
        ...
        uint256 beforeBalance0 = token0.balanceOf(owner);
        controller.liquidate(vaultId, DataType.LiquidationOption(getLowerSqrtPrice(), getUpperSqrtPrice(), 54, true));
        uint256 afterBalance0 = token0.balanceOf(owner);
