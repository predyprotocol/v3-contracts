...
contract PricingModule2 {
     ...
     */
    function calculateInstantRate(uint256 _utilizationRatio) external view returns (uint256) {
        // TODO
        return 500;
    }
    ...
    function calculateMinCollateral(
        ...
        minCollateral = calculateDailyPremium(_isMarginZero, atmPrice, _lowerSqrtPrice, _upperSqrtPrice, 2 * 1e12);
    }
